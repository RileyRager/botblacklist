...
async def blacklist(interaction : discord.Interaction,discord_user : str,discord_id  : int,reason : str, roblox_user : str = "N/A",roblox_id : int = 000000000,roblox_link : str = "N/A", blacklistdoc : str ="coming soon",ping : str = None):
